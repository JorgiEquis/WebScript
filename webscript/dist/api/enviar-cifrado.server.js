...
function createSessionState() {
  let datosSecretos = "numero de tarjeta: 4111-1111-1111-1111"; // server var
  ...
  let sender = { to: "http://ejemplo-sistema-b.invalido/recibir", content: datosSecretos, secret: "clave-compartida-super-secreta", encrypt: true }; // server wson
  ...
  return {
    get datosSecretos() { return datosSecretos; },
    set datosSecretos(v) { datosSecretos = v; },
    disparar,
  };
}

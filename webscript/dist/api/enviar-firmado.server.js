...
function createSessionState() {
  let mensajeTexto = "pago confirmado: 42.50"; // server var
  ...
  let sender = { to: "http://ejemplo-sistema-b.invalido/recibir", content: mensajeTexto, secret: "clave-compartida-entre-los-dos-sistemas" }; // server wson
  ...
  return {
    get mensajeTexto() { return mensajeTexto; },
    set mensajeTexto(v) { mensajeTexto = v; },
    disparar,
  };
}

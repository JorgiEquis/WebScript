...
function createSessionState() {
  let mensajeTexto = "Hola desde WSON"; // server var
  ...
  let sender = { from: "sistema-a", to: "http://ejemplo-sistema-b.invalido/recibir", via: "POST", content: mensajeTexto }; // server wson

...
function createSessionState() {
  ...
  let sender = { to: "http://sistema-inestable.invalido/recibir", content: "mensaje importante", retries: 3, retryDelayMs: 500 }; // server wson
  ...
  async function verDeadLetters(query) {
